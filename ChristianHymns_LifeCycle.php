...
include_once('ChristianHymns_InstallIndicator.php');

class ChristianHymns_LifeCycle extends ChristianHymns_InstallIndicator {
    ...
    public function install() {
        ...
        $this->installMenusAndCategories();
    ...
    public function uninstall() {
        $this->otherUninstall();
        $this->uninstallMenusAndCategories();
